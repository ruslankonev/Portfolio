...
/**
* @title SuperSafeToken token
*/
contract SuperSafeToken is MintableToken, BurnableToken {

    using SafeMath for uint256;

    string  public name = "Super Safe Token";
    string  public symbol = "SFT";
    uint256 constant public decimals = 18;
    uint256 constant dec = 10**decimals;
    uint256 public constant initialSupply = 100000000*dec; // 100 000 000 Super Safe
