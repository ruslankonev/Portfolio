...
class ListWidget extends Widget{
    ...
    protected function createLink($key, $value)
    {
        ...
        //$short = mb_strtoupper(mb_substr($key, 0, 3, "UTF-8"));

       return Html::a("<button class=\"lang-switch__item js-lang-switch-item\">".$key."</button></a>",
                        ['/languages/default/index', 'lang' => $value],
