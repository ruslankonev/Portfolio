...
return [
    ...
    'After registration you will receive an email with the generated password.'=>'После регистрации вы получите письмо с cгенерированным паролем.',
    ...
    'Thank you, registration is now complete.<br>Please follow the <a href="{link}">link</a> and  authenticate in to your account using the data received from email.' => 'Ваш аккаунт был успешно активирован. Пожалуйста перейдите по <a href="{link}">ссылке</a> и авторизуйтесь в своем личном кабинете используя данные полученные из email письма.',
    ...
    'Balance'=>'Баланс токенов ELP',
    'Balance Bonus'=>'Балан бонус',
    'Last name'=>'Фамилия',
    ...
    'I hereby confirm to be more than 18 years and not under any restrictions to use the Website and participate in the E-talon token sale or conduct any operations with cryptocurrency under applicable law;' => 'Настоящим я подтверждаю, что мне больше 18 лет и не имею никаких ограничений на использование сайта и участие в продаже токенов E-talon или проведение каких-либо операций с криптовалютами в соответствии с действующим законодательством;',
    'I hereby confirm that I have never been engaged in any illegal activity, including but not limited to money laundering and financing of terrorism, and will not be using the Website for any illegal activity;' => 'Настоящим я подтверждаю, что я никогда не занимался какой-либо незаконной деятельностью, включая отмыванием денег и финансирование терроризма, и не буду использовать сайт для любой незаконной деятельности;',
    'I hereby confirm to solely control the address and/or cryptocurrency wallet used for the token sale contribution and not act on behalf of any third party and not to transfer the control of the mentioned address to any third party prior to have received GloW tokens;' => 'Настоящим я подтверждаю, что только я контролирую адрес или криптовалютный кошелек, используемый для вклада в продажу токенов, а не действую от имени какой-либо третьей стороны и не передаю контроль над указанным адресом какой-либо третьей стороне до получения токенов GloW;',
    'I hereby confirm to take full responsibility for compliance with all local laws, rules and regulations;' => 'Настоящим подтверждаю, что несу полную ответственность за соблюдение всех местных законов, правил и положений;',
    'I hereby confirm that I have carefully read and accept with <a href="WP_en.docx" download target="_balnk"><b>Whitepaper</b></a> and <a href="TermsConditionsENG.docx" download target="_balnk"><b>Terms and conditions</b></a>.' => 'Настоящим подтверждаю, что я внимательно прочитал и согласился с <a href="WP_en.docx" download target="_balnk"><b>Whitepaper</b></a> и <a href="TermsConditionsENG.docx" download target="_balnk"><b>Условиями использования</b></a>.',
    'Go to my account'=>'Перейти в личный кабинет'
];
