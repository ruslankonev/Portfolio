...
contract GlowSale is Ownable {
    ...
    address founders = 0x7eDE8260e573d3A3dDfc058f19309DF5a1f7397E; // 30% - основантели проекта
    address bounty = 0x0cdb839B52404d49417C8Ded6c3E2157A06CdD37; // 10% - для баунти программы
    address reserve = 0xCe66E79f59eafACaf4CaBaA317CaB4857487E3a1; // 10% - для резерва

    mapping(address=>bool) public whitelist;

    uint256 public startPreSale = now; //1527811201; // Friday, 01-Jun-18 00:00:01 UTC
    ...
    uint256 hardCapSale = 46800000*1e6; // 46 800 000 tokens
    ...
    uint256 public soldTokensSale; // 46 800 000 - количество проданных на основной распродаже токенов
