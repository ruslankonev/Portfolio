...
/**
 * @title CrowdSale
 * @dev https://github.com/elephant-marketing/FBway_smart/blob/master/Smart_contract/contracts/CloseICO.sol */
contract CloseICO is Ownable {
    ...
    address founders = 0x7eDE8260e573d3A3dDfc058f19309DF5a1f7397E; // 20 % - founders
    address bounty = 0x0cdb839B52404d49417C8Ded6c3E2157A06CdD37; // 3 % - bounty
    ...
    function closeSale(address _investor, uint256 _value) internal {
        ...
        uint256 tokensByStage = tokens.mul(25).div(100);

        tokens = tokens.add(tokensByStage); // 70%
