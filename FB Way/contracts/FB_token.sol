...
* @title FBWcoin token
*/
contract FBWayToken is MintableToken, BurnableToken {

    using SafeMath for uint256;

    string  public name = "FBWcoin";
    string  public symbol = "FBW";
    uint256 constant public decimals = 18;
    uint256 constant dec = 10**decimals;
    uint256 public constant initialSupply = 100000000*dec; // 100 000 000 FBWcoin
